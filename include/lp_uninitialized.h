...
namespace lp
{
    ...
    inline ForwardIterator uninitialized_copy(InputIterator first, InputIterator last, ForwardIterator result)
    {
        ...
        return _uninitialized_copy(first, last, result, std::is_trivial<ValueType>());
    }
    ...
    inline void uninitialized_fill(ForwardIterator first, ForwardIterator last, const T &value)
    {
        ...
        typedef typename std::conditional<std::is_trivial<T>::value, std::true_type, std::false_type>::type TrivialType;

        // 然后使用这个类型来调用 _uninitialized_fill 函数
        _uninitialized_fill(first, last, value, TrivialType{});
    }
    ...
    inline ForwardIterator uninitialized_fill_n(ForwardIterator first, Size n, const T &value)
    {
        ...
        // 然后使用这个类型来调用 _uninitialized_fill 函数
        return _uninitialized_fill_n(first, n, value, TrivialType{});
    }
